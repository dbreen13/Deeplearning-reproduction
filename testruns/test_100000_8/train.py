...
opt['iterations'] = 100000 # The model will run for these many iterations.
...
train_files = glob.glob('/home/demibreen/project/data/Sony/short/short_train/*.ARW')
gt_files =glob.glob('/home/demibreen//project/data/Sony/long/long_train/*.ARW')
