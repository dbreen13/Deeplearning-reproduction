...
opt['reduce_lr_by'] = 0.02 # Reduce learning rate by 10 times
opt['atWhichReduce'] = [250000] # Reduce learning rate at these iterations.
opt['batch_size'] = 8
opt['atWhichSave'] = [2,100002,150002,200002,250002,300002,350002,400002,450002,500000,550000, 600000,650002,700002,750000,800000,850002,900002,950000,1000000] # testing will be done at these iterations and corresponding model weights will be saved.
...
train_files = glob.glob('/home/jesseconijn/data/Sony/short/short_train/*.ARW')
gt_files =glob.glob('/home/jesseconijn/data/Sony/long/long_train/*.ARW')
...
test_files = glob.glob('/home/jesseconijn/data/Sony/short/short_test/*.ARW') 
gt_files +=glob.glob('/home/jesseconijn/data/Sony/long/long_test/*.ARW')
if dry_run:
